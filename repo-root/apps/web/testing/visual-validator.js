...
class VisualValidator {
  ...
  async validateApplication() {
    ...
    try {
      ...
      // Test each page
      const testPages = [
        { name: 'homepage', url: 'http://localhost:3001/', expectedContent: ['LocumTrueRate', 'Find Your Perfect Healthcare'] },
        { name: 'dashboard', url: 'http://localhost:3001/dashboard', expectedContent: ['Welcome back', 'Active Applications'] },
        { name: 'calculator', url: 'http://localhost:3001/tools/calculator', expectedContent: ['Calculator', 'Contract Details'] },
        { name: 'search-jobs', url: 'http://localhost:3001/search/jobs', expectedContent: ['Find Healthcare Jobs'] }
      ];
