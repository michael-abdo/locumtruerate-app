...
export const metadata: Metadata = {
  title: 'GDPR Compliance | LocumTrueRate',
  description: 'How LocumTrueRate complies with the General Data Protection Regulation (GDPR) for EU healthcare professionals.',
  robots: 'index, follow',
}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                  ...
                  <button className="mt-2 px-3 py-1 bg-indigo-600 text-white text-xs rounded hover:bg-indigo-700">
                    Export Data
                  </button>
                </div>
