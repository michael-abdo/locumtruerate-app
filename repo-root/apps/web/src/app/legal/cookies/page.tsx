...
export const metadata: Metadata = {
  title: 'Cookie Policy | LocumTrueRate',
  description: 'How LocumTrueRate uses cookies and tracking technologies to improve your experience on our healthcare job platform.',
  robots: 'index, follow',
}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="px-4 py-2 border border-blue-600 text-blue-600 text-sm rounded-md hover:bg-blue-50">
                    Accept All Cookies
                  </button>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  ...
                  <div className="bg-white border border-blue-200 rounded p-3 text-center">
                    ...
                    <button className="text-xs bg-blue-600 text-white px-2 py-1 rounded">ON</button>
                  </div>
                  <div className="bg-white border border-blue-200 rounded p-3 text-center">
                    <div className="text-lg mb-2">📊</div>
                    <h4 className="font-medium text-blue-800 text-sm">Analytics</h4>
                    <button className="text-xs bg-gray-300 text-gray-700 px-2 py-1 rounded">OFF</button>
                  </div>
                  <div className="bg-white border border-blue-200 rounded p-3 text-center">
                    <div className="text-lg mb-2">📢</div>
