        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="mb-8 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
              <a onClick={() => handleSectionClick('information-collection')} className="text-blue-600 hover:text-blue-800 cursor-pointer">1. Information We Collect</a>
              <a onClick={() => handleSectionClick('how-we-use')} className="text-blue-600 hover:text-blue-800 cursor-pointer">2. How We Use Information</a>
              <a onClick={() => handleSectionClick('sharing')} className="text-blue-600 hover:text-blue-800 cursor-pointer">3. Information Sharing</a>
              <a onClick={() => handleSectionClick('data-security')} className="text-blue-600 hover:text-blue-800 cursor-pointer">4. Data Security</a>
              <a onClick={() => handleSectionClick('your-rights')} className="text-blue-600 hover:text-blue-800 cursor-pointer">5. Your Rights</a>
              <a onClick={() => handleSectionClick('cookies')} className="text-blue-600 hover:text-blue-800 cursor-pointer">6. Cookies & Tracking</a>
              <a onClick={() => handleSectionClick('healthcare-specific')} className="text-blue-600 hover:text-blue-800 cursor-pointer">7. Healthcare Data</a>
              <a onClick={() => handleSectionClick('international')} className="text-blue-600 hover:text-blue-800 cursor-pointer">8. International Users</a>
              <a onClick={() => handleSectionClick('changes')} className="text-blue-600 hover:text-blue-800 cursor-pointer">9. Policy Changes</a>
              <a onClick={() => handleSectionClick('contact')} className="text-blue-600 hover:text-blue-800 cursor-pointer">10. Contact Us</a>
            </div>
          </div>
