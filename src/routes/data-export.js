 ...
 */
router.get('/request-deletion', requireAuth, asyncHandler(async (req, res) => {
  ...
  return createSuccessResponse(res, 200, deletionInfo);
}));
 ...
 */
router.get('/privacy-summary', requireAuth, asyncHandler(async (req, res) => {
  ...
  return createSuccessResponse(res, 200, privacySummary);
}));
