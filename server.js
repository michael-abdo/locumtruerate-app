  ...
  res.end(`
    ...
    <body>
      <div class="container">
        ...
        <div class="status ${environment === 'staging' ? 'staging' : environment === 'production' ? 'production' : 'demo'}">
        ...
        <ul>
          <li><strong>Deployment Time:</strong> <span class="timestamp">${new Date().toISOString()}</span></li>
          <li><strong>Environment:</strong> ${environment}</li>
          <li><strong>Process:</strong> ${environment === 'staging' ? 'Auto-deployed from GitHub push' : 'Manual deployment demo'}</li>
        </ul>
